...
public class BulkLoaderConfig extends CommonConfig {
  ...
  /**
   * set BulkLoaderAdvancedConfig decide the data whether to sort or distinct, detail see
   * {@link BulkLoaderAdvancedConfig}
  ...
  /**
   * This class supports two options: enableSort and enableDistinct. Pegasus bulkload require the data
  ...
  public static class BulkLoaderAdvancedConfig implements Serializable {
    ...
    /**
     * set whether to distinct the [hashKeyLength][hashKey][sortKey] of pegasus records
     * generated by resource data, please make sure the data has been distinct base the above
     * rule, otherwise, don't set false.
     *
