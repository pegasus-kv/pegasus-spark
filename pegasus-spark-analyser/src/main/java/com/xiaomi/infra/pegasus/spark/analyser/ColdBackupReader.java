...
class ColdBackupReader implements PegasusReader {

  private static final Log LOG = LogFactory.getLog(ColdBackupReader.class);
  ...
  ColdBackupReader(ColdBackupConfig config) throws PegasusSparkException {
